import React, { useState } from "react"; // Import useState to handle form inputs

import { supabase } from "@/main.tsx";

export default function Index() {
  // Capitalize the component name (Index)
  const [email, setEmail] = useState(""); // Use state to handle email input
  const [password, setPassword] = useState(""); // Use state to handle password input

  async function signInWithEmail(event) {
    // Pass event as a parameter to access it
